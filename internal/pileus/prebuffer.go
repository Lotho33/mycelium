...
// sendProgress. Best-effort: any failure (including an interactive
// verification response on the playlist) just means no warm cache and the
// resolve proceeds. Honours ctx cancellation (user backs out) and its own
