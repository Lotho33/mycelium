...
type CreateProfileRequest struct {
	...
	// Optional; the server stores "{}" when empty and never parses the contents.
...
type ProfileResponse struct {
	...
	// Opaque JSON blob of person-scoped client preferences. The client owns the
	// schema; the server only stores and echoes it. Profiles are server-wide,
	// so this follows the person across every paired device.
...
// setting. preferences_json is stored verbatim ("{}" to clear).
...
const file_auth_proto_rawDesc = "" +
	...
	"\n" +
	"expires_at\x18\x02 \x01(\x03R\texpiresAtJ\x04\b\x03\x10\x04R\x05error\"\x9d\x01\n" +
	"\x14CreateProfileRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1d\n" +
	"\n" +
	"avatar_url\x18\x02 \x01(\tR\tavatarUrl\x12)\n" +
	"\x10preferences_json\x18\x05 \x01(\tR\x0fpreferencesJsonJ\x04\b\x03\x10\x04J\x04\b\x04\x10\x05R\bis_childR\x11parental_pin_hash\"\xad\x01\n" +
	...
	"\x10preferences_json\x18\x06 \x01(\tR\x0fpreferencesJsonJ\x04\b\x04\x10\x05J\x04\b\x05\x10\x06R\bis_childR\ahas_pin\"\x15\n" +
	...
	"\x02ok\x18\x01 \x01(\bR\x02okJ\x04\b\x02\x10\x03R\x05error\"\x91\x01\n" +
	"\x14UpdateProfileRequest\x12\x1d\n" +
	"\n" +
	"profile_id\x18\x01 \x01(\tR\tprofileId\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x1d\n" +
	"\n" +
	"avatar_url\x18\x03 \x01(\tR\tavatarUrlJ\x04\b\x04\x10\x05J\x04\b\x05\x10\x06R\bis_childR\x11parental_pin_hash\"h\n" +
...
var file_auth_proto_goTypes = []any{
	...
	(*UpdateProfileRequest)(nil),         // 8: mycelium.UpdateProfileRequest
	(*SetProfilePreferencesRequest)(nil), // 9: mycelium.SetProfilePreferencesRequest
	(*RefreshTokenRequest)(nil),          // 10: mycelium.RefreshTokenRequest
	(*DeviceInfo)(nil),                   // 11: mycelium.DeviceInfo
	(*ListDevicesRequest)(nil),           // 12: mycelium.ListDevicesRequest
...
var file_auth_proto_depIdxs = []int32{
	...
	11, // 1: mycelium.ListDevicesResponse.devices:type_name -> mycelium.DeviceInfo
